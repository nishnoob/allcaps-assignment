import { Settings, Copy, Maximize2, Grid, RotateCcw, Share2, Bookmark, MoreVertical } from 'lucide-react';
...
const MainChat = () => {
  ...
  return (
    <div className="flex-1 flex flex-col bg-white shadow-sm rounded-2xl border border-border" onMouseUp={handleMouseUp}>
      {/* Header */}
